              ...
              <div className={styles.testimonial}>
                <swiper-slide>
                  <div className={styles.cols}>
                    ...
                    <h4 className={styles.testimonialauth}>
                      <strong>Michelle Dede</strong>
                    </h4>
                  </div>
                  <div className={styles.testimonialimg}>
                    <img src={img} alt="" width="226px" height="230px" />
                  </div>
                </swiper-slide>
              </div>
              <div className={styles.testimonial}>
                <swiper-slide>
                  <div className={styles.cols}>
                    <div className={styles.quote}>“</div>
                    <p className={styles.testimonialtext}>
                      I’m extremely happy that I know this application. I’ve
                      wished for it for so long. Booking buses is way easier
                      now.
                    </p>
                    <h4 className={styles.testimonialauth}>
                      <strong>Francis Akah</strong>
                    </h4>
                  </div>
                  <div className={styles.testimonialimg}>
                    <img src={img1} width="226px" height="230px" alt="" />
                  </div>
                </swiper-slide>
              </div>
              <div className={styles.testimonial}>
